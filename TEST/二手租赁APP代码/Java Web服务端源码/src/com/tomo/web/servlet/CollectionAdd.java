...
public class CollectionAdd extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "select * from collect where shopid ="+Integer.valueOf(shopId)+" and username =?";
		collect = dao.findUnique(sql,userName);
		//Boolean userNameIs = collect.getUserName().equalsIgnoreCase(userName);
		if(collect == null){
			collect = new Collect();
