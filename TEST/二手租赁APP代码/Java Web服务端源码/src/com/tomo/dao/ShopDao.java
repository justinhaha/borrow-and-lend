...
public interface ShopDao extends BaseDao<Shop> {
	...
	public PageModel<Shop> findByPager(String condition, String value, int pageSize, int pageNo);
	public PageModel<Shop> findByPager(String string1,String string2,String aim ,int pageSize, int pageNo);
